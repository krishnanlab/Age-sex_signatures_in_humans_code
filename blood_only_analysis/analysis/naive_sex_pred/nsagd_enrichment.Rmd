...
nsagd <- read_tsv("../../results/naive_sex_prediction_ranks/sagd_enrichment_blood_samples.tsv") %>% 
...
```{r}
bnsagd_heatmap <- make_zscore_heatmap(nsagd)
```

```{r}
ggsave("~/Desktop/naive_blood-only_sagd_enrichment_heatmap.pdf", width = 12, height = 6, plot = bnsagd_heatmap)
```
