...
auroc_files <- list.files("../../results/age_prediction_by_sex/rnaseq/output_files/",
                          full.names = T, pattern = "*_auroc_*")
auprc_files <- list.files("../../results/age_prediction_by_sex/rnaseq/output_files/",
                          full.names = T, pattern = "*_auprc_*")
sample_prob_files <- list.files("../../results/age_prediction_by_sex/rnaseq/output_files/",
                                full.names = T, pattern = "*_sample_probabilities_*")
model_weights_files <- list.files("../../results/age_prediction_by_sex/rnaseq/output_files/",
...
auroc %>% 
  write_delim("../../results/age_prediction_by_sex/rnaseq/auroc_results_from_rnaseq_blood_models.tsv",
              delim = "\t", col_names = T)

auprc %>% 
  write_delim("../../results/age_prediction_by_sex/rnaseq/auprc_results_from_rnaseq_blood_models.tsv",
              delim = "\t", col_names = T)

sample_probs %>% 
  write_delim("../../results/age_prediction_by_sex/rnaseq/sample_probabilites_from_rnaseq_blood_models.tsv",
              delim = "\t", col_names = T)

model_weights %>% 
  write_delim("../../results/age_prediction_by_sex/rnaseq/model_weights_from_rnaseq_blood_models.tsv",
              delim = "\t", col_names = T)
