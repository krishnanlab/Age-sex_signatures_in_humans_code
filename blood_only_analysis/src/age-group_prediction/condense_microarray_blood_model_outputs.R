...
auprc_files <- list.files("../../results/age_prediction_by_sex/microarray/output_files/",
...
auroc %>% 
  write_delim("../../results/age_prediction_by_sex/microarray/auroc_results_from_microarray_blood_models.tsv",
              delim = "\t", col_names = T)

auprc %>% 
  write_delim("../../results/age_prediction_by_sex/microarray/auprc_results_from_microarray_blood_models.tsv",
              delim = "\t", col_names = T)

sample_probs %>% 
  write_delim("../../results/age_prediction_by_sex/microarray/sample_probabilites_from_microarray_blood_models.tsv",
              delim = "\t", col_names = T)

model_weights %>% 
  write_delim("../../results/age_prediction_by_sex/microarray/model_weights_from_microarray_blood_models.tsv",
              delim = "\t", col_names = T)
