...
rl <- read_tsv("~/projects/age-sex-prediction/blood-only_analysis/data/blood_labels/refine.bio_blood_samples.tsv") %>% 
  select(experiment, run, sex, fine_age_group)
ml <- read_tsv("~/projects/age-sex-prediction/blood-only_analysis/data/blood_labels/gpl570_blood_samples.tsv") %>% 
...
```{r}
write_dir <- "~/projects/age-sex-prediction/blood-only_analysis/data/blood_labels/"
