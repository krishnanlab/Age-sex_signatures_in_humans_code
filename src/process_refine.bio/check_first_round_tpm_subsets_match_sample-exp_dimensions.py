...
sample_id_output_dir = "/mnt/research/compbio/krishnanlab/data/rnaseq/refine.bio/aggregated_sample_ID_arrays"
...
for num in range(0,718):
  ...
  expression_subset = np.load(expression_output_dir + "/refine.bio_labeled_subset" + str(num) + "_TPM_data.npy")
