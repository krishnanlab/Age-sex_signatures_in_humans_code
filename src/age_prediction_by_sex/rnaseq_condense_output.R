...
auroc <- auroc %>% 
  ...
  mutate(asinh = ifelse(grepl("no-asinh", parameters), F, T)) %>% 
...
auroc %>% 
  write_delim("../../results/age_prediction_by_sex/rnaseq/auroc_results.tsv",
              delim = "\t", col_names = T)

sample_probs %>% 
  write_delim("../../results/age_prediction_by_sex/rnaseq/sample_probabilites_from_model_with_chosen_parameters.tsv",
              delim = "\t", col_names = T)

model_weights %>% 
  write_delim("../../results/age_prediction_by_sex/rnaseq/model_weights_from_model_with_chosen_parameters.tsv",
              delim = "\t", col_names = T)