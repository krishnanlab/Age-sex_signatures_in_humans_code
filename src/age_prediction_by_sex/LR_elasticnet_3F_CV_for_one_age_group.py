...
if args.data_type == "microarray":
  auroc_results.to_csv(results_path + "3FCV_elasticnet_LR_auroc_" + args.std_scale + "_std_scaling_" + args.sex + "_" + args.pos_age_group + "_results_with_" + args.age_group_type + "_ags.tsv", sep = "\t", header = True, index = False)
  model_weights.to_csv(results_path + "3FCV_elasticnet_LR_model_weights_" + args.std_scale + "_std_scaling_" + args.sex + "_" + args.pos_age_group + "_weights_with_" + args.age_group_type + "_ags.tsv", sep = "\t", header = True, index = False)
  sample_probs.to_csv(results_path + "3FCV_elasticnet_LR_sample_probabilities_" + args.std_scale + "_std_scaling_" + args.sex + "_" + args.pos_age_group + "_results_with_" + args.age_group_type + "_ags.tsv", sep = "\t", header = True, index = False)
...
if args.data_type == "rnaseq":
  if args.feature: 
    ...
    sample_probs.to_csv(results_path + "3FCV_elasticnet_LR_sample_probabilities_" + args.std_scale + "_std_scaling_" + args.sex + "_" + args.pos_age_group + "_results_with_" + args.age_group_type + "_ags.tsv", sep = "\t", header = True, index = False)
  if not args.feature:
    auroc_results.to_csv(results_path + "3FCV_elasticnet_LR_auroc_no-asinh_transformation_" + args.std_scale + "_std_scaling_" + args.sex + "_" + args.pos_age_group + "_results_with_" + args.age_group_type + "_ags.tsv", sep = "\t", header = True, index = False)
    model_weights.to_csv(results_path + "3FCV_elasticnet_LR_model_weights_no-asinh_transformation_" + args.std_scale + "_std_scaling_" + args.sex + "_" + args.pos_age_group + "_weights_with_" + args.age_group_type + "_ags.tsv", sep = "\t", header = True, index = False)
    sample_probs.to_csv(results_path + "3FCV_elasticnet_LR_sample_probabilities_no-asinh_transformation_" + args.std_scale + "_std_scaling_" + args.sex + "_" + args.pos_age_group + "_results_with_" + args.age_group_type + "_ags.tsv", sep = "\t", header = True, index = False)
