...
out_path <- "~/projects/age-sex-prediction/results/naive_sex_prediction/gene_enrichment_analysis/output_files/"
...
output <- output[-1,]
output %>% 
  write_delim(paste0(out_path, dt, file_name, "_ranks_", term_file_name, "_terms_zscores_from_list_ranking.tsv"),
              delim = "\t", col_names = T)
