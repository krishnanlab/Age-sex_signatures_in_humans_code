...
gene_chr <- read_tsv("~/projects/age-sex-prediction/paper_figures/final_results_files/small_step_naive_sex_prediction/rnaseq_unsigned_balanced_accuracy_info_file.tsv") %>% 
