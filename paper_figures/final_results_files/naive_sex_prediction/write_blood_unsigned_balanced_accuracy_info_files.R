...
# added in the no_var addition, remove age groups
rf <- rf %>% 
  filter(!age_group %in% c("fetus", "elderly"))
...
rf %>% 
  write_tsv("~/projects/age-sex-prediction/paper_figures/final_results_files/small_step_naive_sex_prediction/blood_rnaseq_unsigned_balanced_accuracy_info_file.tsv")

mf %>% 
  write_tsv("~/projects/age-sex-prediction/paper_figures/final_results_files/small_step_naive_sex_prediction/blood_microarray_unsigned_balanced_accuracy_info_file.tsv")
