...
rf <- read_tsv("~/projects/age-sex-prediction/results/naive_sex_prediction/rnaseq/fine_age_groups/final_gene_cut_data_all_chromosomes.tsv")
mf <- read_tsv("~/projects/age-sex-prediction/results/naive_sex_prediction/microarray/fine_age_groups/final_gene_cut_data_all_chromosomes.tsv")
...
rfaddition <-  tibble(age_group = rep(fine_ags, each = 164), gene = rep(no_var_genes, times = 11), cutoff = 'none', 
...
rf %>% 
  write_tsv("~/projects/age-sex-prediction/paper_figures/final_results_files/small_step_naive_sex_prediction/rnaseq_unsigned_balanced_accuracy_info_file.tsv")

mf %>% 
  write_tsv("~/projects/age-sex-prediction/paper_figures/final_results_files/small_step_naive_sex_prediction/microarray_unsigned_balanced_accuracy_info_file.tsv")
