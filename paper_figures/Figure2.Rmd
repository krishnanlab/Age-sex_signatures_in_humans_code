...
```{r include=FALSE}
full_rs <- read_tsv("~/projects/age-sex-prediction/paper_figures/final_results_files/small_step_naive_sex_prediction/rnaseq_unsigned_balanced_accuracy_info_file.tsv")

full_ms <- read_tsv("~/projects/age-sex-prediction/paper_figures/final_results_files/small_step_naive_sex_prediction/microarray_unsigned_balanced_accuracy_info_file.tsv")
