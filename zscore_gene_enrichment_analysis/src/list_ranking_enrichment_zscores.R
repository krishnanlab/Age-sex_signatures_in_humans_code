...
if (gene_set == "sex-strat_gtex_tissue-spec"){
  terms_path <- "~/projects/age-sex-prediction/final_list-rank-zscore_gene_enrichment_analyses/data/gene_sets/sex-strat_gtex_tissue-spec/sex-strat_gtex_tissue-spec_gene-group_file.tsv"
}

terms = read_tsv(terms_path, col_names = T)
colnames(terms) = c("gene_id", "group") 

out_path <- paste0("~/projects/age-sex-prediction/final_list-rank-zscore_gene_enrichment_analyses/results/",
