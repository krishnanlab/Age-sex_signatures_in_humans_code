...
```{r}
female_mwguo_heatmap <- make_zscore_heatmap(mwguo, 'female')
```

```{r}
ggsave("~/Desktop/female_model_weight_guo_enrichment_heatmap.pdf", 
       width = 12, height = 6, plot = female_mwguo_heatmap)
```

```{r}
male_mwguo_heatmap <- make_zscore_heatmap(mwguo, 'male')
```

```{r}
ggsave("~/Desktop/male_model_weight_guo_enrichment_heatmap.pdf", 
       width = 12, height = 6, plot = male_mwguo_heatmap)
```
